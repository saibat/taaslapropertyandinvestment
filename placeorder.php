...
<html lang="en">
      ...
      <div id="plant" class="section_Clients layout_padding padding_bottom_0">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
				     <li><a href="items.php"><h2>Items</h2></a></li>
                     
                     <span style="text-align: center;">Click on items to view our products</span>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-sm-12">
                        ...
                        <div id="items" class="carousel slide" data-ride="carousel">

  <!-- Indicators -->
  <ul class="carousel-indicators">
    <li data-target="#items" data-slide-to="0" class="active"></li>
    <li data-target="#items" data-slide-to="1"></li>
    <li data-target="#items" data-slide-to="2"></li>
  </ul>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="titlepage">
                           <div class="john">
                              <div class="john_image"><img src="images/certificate.jpg" style="max-width: 100%;"></div>
                              <div class="john_text">CAC<span style="color: #fffcf4;">Certificate</span></div>
